...
public class ChessProject extends JFrame implements MouseListener, MouseMotionListener {
	...
	*/
	private Boolean checkWhiteOponent(int newX, int newY) {
		...
		if (((tmp1.contains("Black")))) {
			oponent = true;
			if (((tmp1.contains("King")))) {//show message saying White wins
	...
	*/
	public void mouseReleased(MouseEvent e) {
		...
		Boolean promotionBlack = false;
		Boolean promotionWhite = false;
		Component c = chessBoard.findComponentAt(e.getX(), e.getY());
		...
		*/
		...
		if (pieceName.equals("WhitePawn")) {
			...
			} else { //This is where all the pawn moves are made
		...
		/*****************************************************************************************************************************************/
			...
			/*Knight can move in a L shape, if xMovment is = 1 then yMovement = 2 and also the oyher way round */

			//check the square we are moving to, if a piece is present is not our own
		...
		if (!validMove) {
			...
			if (promotionBlack) {
				//White pawn gets changes to whiteQueen
				...
				if (c instanceof JLabel) {
					...
					//Black pawn changes to BlackQueen
